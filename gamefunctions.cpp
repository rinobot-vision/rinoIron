...
void GameFunctions::collaborator() {
    ...
    if (teamRobot[0].getFunction() == COLLABORATOR && indexRobot != 0)
        collaboratorK = teamRobot[0].getDataState();
    else if (teamRobot[1].getFunction() == COLLABORATOR && indexRobot != 1)
        collaboratorK = teamRobot[1].getDataState();
    else if (teamRobot[2].getFunction() == COLLABORATOR && indexRobot != 2)
