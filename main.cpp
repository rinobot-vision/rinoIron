...
int main(int argc, char *argv[]) {
    ...
    centroidAtk.y = 1.8/2*100;
    centroidDef.y = 1.8/2*100;
    centroidAtk.x = 2.35*100;
    centroidDef.x = 0.15*100;
    ...
    while(1) {
        ...
        if(refereeClient->getLastFoul() == VSSRef::Foul::PENALTY_KICK){
            if(refereeClient->getLastFoulColor() == VSSRef::Color::BLUE){
                replacerClient->placeRobot(4, ourSideIsLeft ? -0.55 : -0.15, ourSideIsLeft ? 0 : 0.6, 90);
                replacerClient->placeRobot(3, -0.15, ourSideIsLeft ? -0.2 : 0.4, 0);
                replacerClient->placeRobot(2, ourSideIsLeft ? 0.65 : -0.15, ourSideIsLeft ? 0 : -0.4, 25);
                replacerClient->placeRobot(0, -0.15, ourSideIsLeft ? 0 : -0.6, 90);
                replacerClient->placeRobot(1, ourSideIsLeft ? -1.06 : 1.06, 0, 0);

                replacerClient->sendFrame();
            }
            if(refereeClient->getLastFoulColor() == VSSRef::Color::YELLOW){
                replacerClient->placeRobot(4, ourSideIsLeft ? 0.15 : 0.55, ourSideIsLeft ? 0 : 0.6, 90);
                replacerClient->placeRobot(3, 0.15, ourSideIsLeft ? 0.4 : -0.2, 0);
                replacerClient->placeRobot(2, ourSideIsLeft ? 0.15 : -0.65, ourSideIsLeft ? -0.4 : 0, -25);
                replacerClient->placeRobot(0, 0.15, ourSideIsLeft ? -0.6 : 0, 90);
                replacerClient->placeRobot(1, ourSideIsLeft ? -1.06 : 1.06, 0, 0);
        ...
        if(refereeClient->getLastFoul() == VSSRef::Foul::KICKOFF){
            if(refereeClient->getLastFoulColor() == VSSRef::Color::BLUE){
                ...
                replacerClient->placeRobot(2, ourSideIsLeft ? -0.08 : 0.29, 0, -15);
            }
                ...
                replacerClient->placeRobot(0, ourSideIsLeft ? -1.10 : 1.10, 0, 90);
                replacerClient->placeRobot(1, ourSideIsLeft ? -0.40 : 0.40, 0.4, 90);
                replacerClient->placeRobot(2, ourSideIsLeft ? -0.29 : 0.08, 0, -15);
            }
            replacerClient->sendFrame();
        }
        ...
        if(refereeClient->getLastFoul() == VSSRef::Foul::FREE_BALL){
            if(refereeClient->getLastFoulQuadrant() == VSSRef::Quadrant::QUADRANT_1){
                replacerClient->placeRobot(4, ourSideIsLeft ?  -0.55 : 0.55, ourSideIsLeft ? 0.6 : -0.4, 90);
                replacerClient->placeRobot(3, ourSideIsLeft ?  0.25 : -0.1 , ourSideIsLeft ? -0.15 : 0.6, 90 );
                replacerClient->placeRobot(2, ourSideIsLeft ?  0.3 : 0.55, ourSideIsLeft ? 0.6 : -0.05, ourSideIsLeft ? 0 : 90);
                replacerClient->placeRobot(1, ourSideIsLeft ?  - 0.15 : 0.8, 0.6, 0);
                replacerClient->placeRobot(0, ourSideIsLeft ?  -1.1 : 1.1, 0.1 , 90);
                replacerClient->sendFrame();
            }
            if(refereeClient->getLastFoulQuadrant() == VSSRef::Quadrant::QUADRANT_2){
                replacerClient->placeRobot(4, ourSideIsLeft ?  -0.55 : 0.55, ourSideIsLeft ? -0.6 : 0.6, 90);
                replacerClient->placeRobot(3, ourSideIsLeft ?  0.1 : -0.3 , ourSideIsLeft ? 0.65 : -0.3, 90 );
                replacerClient->placeRobot(2, ourSideIsLeft ?  -0.55 : -0.3, ourSideIsLeft ? -0.05 : 0.6, ourSideIsLeft ? 90 : 0);
                replacerClient->placeRobot(1, ourSideIsLeft ?  - 0.8 : 0.15, 0.6, 0);
                replacerClient->placeRobot(0, ourSideIsLeft ?  -1.1 : 1.1, 0.1 , 90);
                replacerClient->sendFrame();
            }
        ...
        if(refereeClient->getLastFoul() == VSSRef::Foul::GOAL_KICK){
            if(refereeClient->getLastFoulColor() == VSSRef::Color::BLUE){
                replacerClient->placeRobot(4, ourSideIsLeft ?  -0.8 : 0.85, ourSideIsLeft ? -0.45 : 0, 0);
                replacerClient->placeRobot(3, ourSideIsLeft ?  0.15 : -0.25 , ourSideIsLeft ? 0.8 : 0 , 0);
                replacerClient->placeRobot(2, ourSideIsLeft ? -0.75 : -0.55 , ourSideIsLeft ? 0.45 : 0, 0);
                replacerClient->placeRobot(1, ourSideIsLeft ? -1.1 : 0.15 ,0 ,0 );
                replacerClient->placeRobot(0, ourSideIsLeft ?  -0.64: 1.1, ourSideIsLeft ? -0.35 : 0, 0);
                replacerClient->sendFrame();
           }
           if(refereeClient->getLastFoulColor() == VSSRef::Color::YELLOW){
               replacerClient->placeRobot(4, ourSideIsLeft ?  -0.85 : 0.8, ourSideIsLeft ? 0 : -0.45, 0);
               replacerClient->placeRobot(3, ourSideIsLeft ?  0.25 : -0.15 , ourSideIsLeft ? 0 : 0.8 , 0);
               replacerClient->placeRobot(2, ourSideIsLeft ? 0.55 : 0.75 , ourSideIsLeft ? 0 : 0.45, 0);
               replacerClient->placeRobot(1, ourSideIsLeft ? -0.15 : 1.1 , ourSideIsLeft ? -0.15 : 0, 0 );
               replacerClient->placeRobot(0, ourSideIsLeft ?  -1.1: 0.64, ourSideIsLeft ? 0 : -0.35, 0);
               replacerClient->sendFrame();
           }
        }
